    ...
    <main>
      ...
      <div className="md:hidden min-h-[calc(100dvh-64px)] flex flex-col relative">
        ...
        <div className="absolute top-4 left-0 right-0 flex items-center justify-center gap-4 z-10">
          <a href="mailto:kar1mr@zodicogai.com" title="kar1mr@zodicogai.com" className="text-white/40 hover:text-white/70 transition-colors">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
          </a>
          <span className="text-white/20 text-[10px]">·</span>
          <a href="https://github.com/VSSK007/ZodicogAI" target="_blank" rel="noopener noreferrer" title="VSSK007/ZodicogAI" className="text-white/40 hover:text-white/70 transition-colors">
