  ...
  return (
    <main className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="mt-4 text-ink-secondary max-w-md">
        This page isn&apos;t on any chart we&apos;ve drawn. The readings, however, are exactly
        where you left them.
      </p>
      <Link
        href="/"
        className="mt-8 inline-flex items-center justify-center rounded-control px-7 py-3 min-h-[48px] text-sm font-semibold text-accent-ink bg-gradient-to-b from-accent-bright to-accent glow-accent hover:brightness-110 transition-all duration-200"
      >
